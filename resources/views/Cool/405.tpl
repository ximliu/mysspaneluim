...
<html lang="zh-CN">
 <head> 
  <title>访问方式不正确 - {$config['appName']}</title> 
  <meta charset="UTF-8" /> 
  ...
  <link rel="stylesheet" type="text/css" href="/theme/cool/assets/css/colors.css" /> 
  <link rel="stylesheet" type="text/css" href="/theme/cool/assets/css/components.css" /> 
  <link rel="stylesheet" type="text/css" href="/theme/cool/assets/css/themes/dark-layout.css" /> 
  <link rel="stylesheet" type="text/css" href="/theme/cool/assets/css/themes/semi-dark-layout.css" /> 
  <!-- BEGIN: Page CSS--> 
  ...
  <link rel="stylesheet" type="text/css" href="/theme/cool/assets/css/pages/error.css" /> 
  <!-- END: Page CSS--> 
 </head> 
 <body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page  pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
       ...
       <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100"> 
        <div class="card-content"> 
         <div class="card-body text-center"> 
          <img src="/theme/cool/assets/images/pages/405.png" class="img-fluid align-self-center" alt="branding logo" /> 
          <h1 class="font-large-2 my-1">405 - 您的访问方式不正确！</h1> 
