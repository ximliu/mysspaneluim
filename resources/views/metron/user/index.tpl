                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="card card-custom gutter-b {$metron['style_shadow']}">
                                        <div class="card-header border-0 pt-5">
                                            <div class="card-title font-weight-bolder">
                                                <div class="card-label {$style[$theme_style]['global']['title']} font-weight-bold font-size-h3">
                                                    <i class="fa fa-tint icon-md {$style[$theme_style]['global']['title']}"></i><strong>
                                                        流量信息</strong>
                                                    <div class="font-size-sm text-muted mt-2">
                                                        峰值速率：{if $user->node_speedlimit!=0}{$user->node_speedlimit}Mbps{else}不限制{/if}</div>
                                                </div>
                                            </div>
                                        </div>
                                                                            ...
                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                ...
                                                                                <g stroke="none" stroke-width="1"
                                                                                   fill="none" fill-rule="evenodd">
                                                                                    <rect x="0" y="0" width="24"
                                                                                          height="24"/>
                                                                                    <path d="M7.67514486,18.731359 C9.6803634,17.3851601 11,15.0966889 11,12.5 C11,9.58867922 9.34119765,7.06479249 6.91718054,5.82192739 C8.29918974,4.68360845 10.0697622,4 12,4 C16.418278,4 20,7.581722 20,12 C20,16.418278 16.418278,20 12,20 C10.4066753,20 8.92214267,19.5342055 7.67514486,18.731359 Z"
                                                                                          fill="#000000" opacity="0.3"/>
                                                                                    <path d="M6.39268296,17.7059641 C4.91588435,16.254539 4,14.2342276 4,12 C4,10.0680854 4.68479668,8.29611365 5.82489501,6.91357974 C7.72637261,8.04773008 9,10.1251292 9,12.5 C9,14.6298467 7.97562469,16.5204376 6.39268296,17.7059641 Z"
                                                                                          fill="#000000"/>
                                                                                </g>
                                                                            </svg>
                                                                        </span>
